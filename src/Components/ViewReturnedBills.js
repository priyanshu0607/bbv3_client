  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      while (position < imgHeight) {
        ...
        pdf.addImage(sliceData, 'PNG', 0, 0, pdfWidth, pageHeight);
  ...
  return (
    <Fragment>
      ...
      <div className="button-container">
        ...
        <button onClick={() => navigate("/view-past-orders")} className="back-home-button">Back</button>
      </div>
    </Fragment>
  );
};

export default ViewReturnedBill;